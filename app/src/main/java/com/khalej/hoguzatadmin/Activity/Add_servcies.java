...
import com.khalej.hoguzatadmin.Adapter.RecyclerAdapter_deletefirst;
...
public class Add_servcies extends AppCompatActivity {
    Toolbar toolbar;
    ProgressBar progressBar;
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private RecyclerAdapter_first recyclerAdapter_secondry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_servcies);
    ...
    public void fetchInfo() {
        ...
        call.enqueue(new Callback<List<contact_category>>() {
            ...
            public void onResponse(Call<List<contact_category>> call, Response<List<contact_category>> response) {
                ...
                recyclerAdapter_secondry = new RecyclerAdapter_first(Add_servcies.this, contactList);
